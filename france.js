document.addEventListener('DOMContentLoaded', () => {
        ...
        layer.eachLayer(function (featureLayer) {
            ...
            if (electionResult) {
                ...
                const popupContent = `
                    ...
                    <b>Previous Winner:</b> ${electionResult.Previous || 'Unknown'}<br>
                    <b>Projected Winner:</b> ${electionResult.Winner || 'Unknown'}<br>
    ...
    loadShapefile('France Data/france-shapefile.zip', map, layer => {
        loadExcelData('France Data/France2rResults.xlsx', data => {
